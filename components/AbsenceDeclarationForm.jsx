...
import { RadioButton } from 'react-native-paper';
import useAbsenceDeclarationLogic from './AbsenceDeclarationLogic';
...
const AbsenceDeclarationForm = ({ onSubmit, onClose }) => {
  const {
    ...
    setDetails,
    handleSubmit
  } = useAbsenceDeclarationLogic({ onSubmit, onClose });
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <RadioButton.Group onValueChange={setReason} value={reason}>
        ...
        <View style={styles.radioContainer}>
          ...
          <Text style={styles.label}>Other (specify in details)</Text>
        </View>
      </RadioButton.Group>
