...
import Icon from 'react-native-vector-icons/MaterialIcons';
import useChatInterfaceLogic from './ChatInterfaceLogic';
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={[
              ...
              <Text style={[
                styles.messageText,
                item.sender !== currentUser.uid && styles.receivedMessageText
              ]}>
                {item.text}
              </Text>
              <Text style={[
                styles.messageTime,
                item.sender !== currentUser.uid && styles.receivedMessageTime
              ]}>
